...
const makeSpanWithOffset = (baseFuzzy: any, offset: DurationNode, offsetDirection: string, duration?: DurationNode): any => ({
  nodeType: 'span',
  start: baseFuzzy,
  duration,
...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "range", "symbols": ["fuzzy", "_", (lexer.has("dash") ? {type: "dash"} : dash), "_", "fuzzy"], "postprocess": d => makeRange(d[0], d[4])},
    ...
    {"name": "span", "symbols": ["duration", "_", "afterConnector", "_", "fuzzy", "_", "forConnector", "_", "duration"], "postprocess": d => makeSpanWithOffset(d[4], d[0], 'future', d[8])},
    {"name": "span", "symbols": ["duration", "_", "beforeConnector", "_", "fuzzy", "_", "forConnector", "_", "duration"], "postprocess": d => makeSpanWithOffset(d[4], d[0], 'past', d[8])},
    {"name": "span", "symbols": ["wordNumber", "_", "unit", "_", "afterConnector", "_", "fuzzy", "_", "forConnector", "_", "duration"], "postprocess": d => makeSpanWithOffset(d[6], makeDuration(parseWordNumber(d[0]), d[2]), 'future', d[10])},
    {"name": "span", "symbols": ["wordNumber", "_", "unit", "_", "beforeConnector", "_", "fuzzy", "_", "forConnector", "_", "duration"], "postprocess": d => makeSpanWithOffset(d[6], makeDuration(parseWordNumber(d[0]), d[2]), 'past', d[10])},
    ...
    {"name": "relativeDate", "symbols": ["duration", "_", "beforeConnector", "_", "fuzzy"], "postprocess": d => ({ ...makeRelativeDate('past', d[0]), baseFuzzy: d[4] })},
    {"name": "relativeDate", "symbols": ["duration", "_", "afterConnector", "_", "fuzzy"], "postprocess": d => ({ ...makeRelativeDate('future', d[0]), baseFuzzy: d[4] })},
    {"name": "relativeDate", "symbols": ["wordNumber", "_", "unit", "_", "beforeConnector", "_", "fuzzy"], "postprocess": d => ({ ...makeRelativeDate('past', makeDuration(parseWordNumber(d[0]), d[2])), baseFuzzy: d[6] })},
    {"name": "relativeDate", "symbols": ["wordNumber", "_", "unit", "_", "afterConnector", "_", "fuzzy"], "postprocess": d => ({ ...makeRelativeDate('future', makeDuration(parseWordNumber(d[0]), d[2])), baseFuzzy: d[6] })},
    ...
    {"name": "fuzzy", "symbols": ["endConnector", "_", "month"], "postprocess": d => makeFuzzy({ period: 'month', month: d[2], modifier: 'end' })},
    {"name": "fuzzy", "symbols": ["month", "_", "endConnector"], "postprocess": d => makeFuzzy({ period: 'month', month: d[0], modifier: 'end' })},
    {"name": "fuzzy", "symbols": ["midModifier", "_", "ofConnector", "_", "month"], "postprocess": d => makeFuzzy({ period: 'month', month: d[4], modifier: 'mid' })},
    {"name": "fuzzy", "symbols": ["earlyModifier", "_", "ofConnector", "_", "month"], "postprocess": d => makeFuzzy({ period: 'month', month: d[4], modifier: 'early' })},
    {"name": "fuzzy", "symbols": ["lateModifier", "_", "ofConnector", "_", "month"], "postprocess": d => makeFuzzy({ period: 'month', month: d[4], modifier: 'late' })},
    {"name": "fuzzy", "symbols": ["wholeModifier", "_", "month"], "postprocess": d => makeFuzzy({ period: 'month', month: d[2] })},
    {"name": "fuzzy", "symbols": ["wholeModifier", "_", "ofConnector", "_", "month"], "postprocess": d => makeFuzzy({ period: 'month', month: d[4] })},
    ...
    {"name": "fuzzy", "symbols": ["nextRelative", "_", "quarterUnit"], "postprocess": d => makeFuzzy({ period: 'quarter', relative: 'next' })},
    {"name": "fuzzy", "symbols": ["lastRelative", "_", "quarterUnit"], "postprocess": d => makeFuzzy({ period: 'quarter', relative: 'last' })},
    {"name": "fuzzy", "symbols": ["thisRelative", "_", "quarterUnit"], "postprocess": d => makeFuzzy({ period: 'quarter', relative: 'this' })},
    {"name": "fuzzy", "symbols": ["pastRelative", "_", "quarterUnit"], "postprocess": d => makeFuzzy({ period: 'quarter', relative: 'past' })},
    ...
    {"name": "time", "symbols": [(lexer.has("integer") ? {type: "integer"} : integer), "_", (lexer.has("ampm") ? {type: "ampm"} : ampm)], "postprocess":  d => {
          ...
          if (val.length === 3) {
            ...
            minute = parseInt(val.slice(1), 10);
          } else if (val.length === 4) {
            hour = parseInt(val.slice(0, 2), 10);
            minute = parseInt(val.slice(2), 10);
          } else {
    ...
    {"name": "wholeModifier", "symbols": [(lexer.has("kw_whole") ? {type: "kw_whole"} : kw_whole)], "postprocess": first},
